...
const ProductForm: React.FC<ProductFormProps> = ({ product, onSave, onCancel, categories, isSaving }) => {
  ...
  const inputClass = "w-full px-3 py-2 border border-stone-300 rounded-md focus:outline-none focus:ring-2 focus:ring-stone-500 transition-shadow disabled:bg-stone-100 text-stone-900";
